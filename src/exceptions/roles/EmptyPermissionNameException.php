...
/**
 * Class EmptyPermissionNameException
 *
 * This exception is thrown when the permission name is empty.
 *
 * @package src\exceptions\roles
 *
 * @since 1.0
 */
class EmptyPermissionNameException extends RolePermissionException
{
    /**
